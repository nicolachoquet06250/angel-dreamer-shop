import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, provide, h, ref, Suspense, Fragment, createElementBlock, cloneVNode, computed, toValue, onServerPrefetch, nextTick, unref, withAsyncContext, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestURL } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/defu/dist/defu.mjs";
import { hasProtocol, isScriptProtocol, joinURL, parseURL, encodePath, decodePath, withQuery } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/ufo/dist/index.mjs";
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import { hash } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { debounce } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/perfect-debounce/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "/home/runner/work/angel-dreamer-shop/angel-dreamer-shop/node_modules/@unhead/vue/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_slug_-lr0GBJAQ.js")
  },
  {
    name: "produits-slug",
    path: "/produits/:slug()",
    component: () => import("./_nuxt/_slug_-BOyR0Rhq.js")
  },
  {
    name: "univers-id",
    path: "/univers/:id()",
    component: () => import("./_nuxt/_id_-CSv8O2fN.js"),
    children: [
      {
        name: "univers-id-category",
        path: ":category()",
        component: () => import("./_nuxt/_category_-CR1QaNUK.js")
      }
    ]
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import("./_nuxt/admin-CRC7E_fA.js"),
    children: [
      {
        name: "admin-tab",
        path: ":tab()",
        component: () => import("./_nuxt/_tab_-BqKKetxt.js")
      },
      {
        name: "admin-path",
        path: ":path(.*)*",
        component: () => import("./_nuxt/_...path_-DpcIMe3t.js")
      }
    ]
  },
  {
    name: "cgu",
    path: "/cgu",
    component: () => import("./_nuxt/cgu-C9G_khMI.js")
  },
  {
    name: "cgv",
    path: "/cgv",
    component: () => import("./_nuxt/cgv-Bv3YfF7e.js")
  },
  {
    name: "changer-mot-de-passe",
    path: "/changer-mot-de-passe",
    component: () => import("./_nuxt/changer-mot-de-passe-DxwDj1E8.js")
  },
  {
    name: "commande",
    path: "/commande",
    component: () => import("./_nuxt/commande-BbtEHgY0.js")
  },
  {
    name: "compte",
    path: "/compte",
    component: () => import("./_nuxt/compte-CApwluQG.js")
  },
  {
    name: "connexion",
    path: "/connexion",
    component: () => import("./_nuxt/connexion-DTTM3UOH.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-lPNpCqQt.js")
  },
  {
    name: "inscription",
    path: "/inscription",
    component: () => import("./_nuxt/inscription-C8zEjAdZ.js")
  },
  {
    name: "mot-de-passe-oublie",
    path: "/mot-de-passe-oublie",
    component: () => import("./_nuxt/mot-de-passe-oublie-B5wVU_CF.js")
  },
  {
    name: "panier",
    path: "/panier",
    component: () => import("./_nuxt/panier-Dv87H6f8.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DFs7m_Ng.js")
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead(() => ({
      ...
      title: isHome.value ? data.value.seoTitle : void 0,
      link: [
      ...
      meta: [
        ...
        { name: "google-site-verification", content: data.value.seoGoogleVerification || void 0 },
        { name: "msvalidate.01", content: data.value.seoBingVerification || void 0 },
        ...
        { name: "twitter:site", content: data.value.seoTwitterSite || void 0 },
        { name: "twitter:creator", content: data.value.seoTwitterCreator || void 0 },
        ...isHome.value ? [
      ...
      script: [{
        ...
        children: JSON.stringify({
          ...
          legalName: data.value.seoOrganizationLegalName || void 0,
          url: data.value.seoOrganizationUrl || baseUrl.value,
          email: data.value.seoOrganizationEmail || void 0,
          telephone: data.value.seoOrganizationPhone || void 0,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BozipGah.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C3Zht_1G.js"));
