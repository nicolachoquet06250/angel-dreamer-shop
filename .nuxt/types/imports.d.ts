...
declare global {
  ...
  const adminPagePath: typeof import('../../utils/admin-routing').adminPagePath
  const adminPageTabs: typeof import('../../utils/admin-routing').adminPageTabs
  const adminSeoPath: typeof import('../../utils/admin-routing').adminSeoPath
  const adminSeoTabs: typeof import('../../utils/admin-routing').adminSeoTabs
  ...
  const hasValidationErrors: typeof import('../../utils/admin-validation').hasValidationErrors
  ...
  const renderSeoTemplate: typeof import('../../utils/seo-template').renderSeoTemplate
  const requestIdleCallback: typeof import('../../node_modules/nuxt/dist/app/compat/idle-callback').requestIdleCallback
  const resolveAdminRoute: typeof import('../../utils/admin-routing').resolveAdminRoute
  const resolveComponent: typeof import('vue').resolveComponent
  const resolveImageVariant: typeof import('../../composables/useThemedImage').resolveImageVariant
  ...
  const useShopCart: typeof import('../../composables/useShopCart').useShopCart
  const useSlots: typeof import('vue').useSlots
  const useState: typeof import('../../node_modules/nuxt/dist/app/composables/state').useState
  const useTemplateRef: typeof import('vue').useTemplateRef
  const useThemedImage: typeof import('../../composables/useThemedImage').useThemedImage
  const useTransitionState: typeof import('vue').useTransitionState
  const validateCartSeo: typeof import('../../utils/admin-validation').validateCartSeo
  const validateCategoryPage: typeof import('../../utils/admin-validation').validateCategoryPage
  const validateHomeContent: typeof import('../../utils/admin-validation').validateHomeContent
  const validateProduct: typeof import('../../utils/admin-validation').validateProduct
  const validateProfileSeo: typeof import('../../utils/admin-validation').validateProfileSeo
  const validateSeo: typeof import('../../utils/admin-validation').validateSeo
  const validateUniversePage: typeof import('../../utils/admin-validation').validateUniversePage
...
declare global {
  ...
  // @ts-ignore
  export type { AdminPageTab, AdminSeoSection, AdminMainTab, AdminTab, AdminRouteState } from '../../utils/admin-routing'
  import('../../utils/admin-routing')
  // @ts-ignore
  export type { ValidationLevel, ValidationIssue } from '../../utils/admin-validation'
  import('../../utils/admin-validation')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly adminPagePath: UnwrapRef<typeof import('../../utils/admin-routing')['adminPagePath']>
    readonly adminPageTabs: UnwrapRef<typeof import('../../utils/admin-routing')['adminPageTabs']>
    readonly adminSeoPath: UnwrapRef<typeof import('../../utils/admin-routing')['adminSeoPath']>
    readonly adminSeoTabs: UnwrapRef<typeof import('../../utils/admin-routing')['adminSeoTabs']>
    ...
    readonly hasValidationErrors: UnwrapRef<typeof import('../../utils/admin-validation')['hasValidationErrors']>
    ...
    readonly renderSeoTemplate: UnwrapRef<typeof import('../../utils/seo-template')['renderSeoTemplate']>
    readonly requestIdleCallback: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/compat/idle-callback')['requestIdleCallback']>
    readonly resolveAdminRoute: UnwrapRef<typeof import('../../utils/admin-routing')['resolveAdminRoute']>
    readonly resolveComponent: UnwrapRef<typeof import('vue')['resolveComponent']>
    readonly resolveImageVariant: UnwrapRef<typeof import('../../composables/useThemedImage')['resolveImageVariant']>
    ...
    readonly useShopCart: UnwrapRef<typeof import('../../composables/useShopCart')['useShopCart']>
    readonly useSlots: UnwrapRef<typeof import('vue')['useSlots']>
    readonly useState: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/state')['useState']>
    readonly useTemplateRef: UnwrapRef<typeof import('vue')['useTemplateRef']>
    readonly useThemedImage: UnwrapRef<typeof import('../../composables/useThemedImage')['useThemedImage']>
    readonly useTransitionState: UnwrapRef<typeof import('vue')['useTransitionState']>
    readonly validateCartSeo: UnwrapRef<typeof import('../../utils/admin-validation')['validateCartSeo']>
    readonly validateCategoryPage: UnwrapRef<typeof import('../../utils/admin-validation')['validateCategoryPage']>
    readonly validateHomeContent: UnwrapRef<typeof import('../../utils/admin-validation')['validateHomeContent']>
    readonly validateProduct: UnwrapRef<typeof import('../../utils/admin-validation')['validateProduct']>
    readonly validateProfileSeo: UnwrapRef<typeof import('../../utils/admin-validation')['validateProfileSeo']>
    readonly validateSeo: UnwrapRef<typeof import('../../utils/admin-validation')['validateSeo']>
    readonly validateUniversePage: UnwrapRef<typeof import('../../utils/admin-validation')['validateUniversePage']>
