...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    if (!((_a = content.value) == null ? void 0 : _a.cgvContent)) {
      throw createError({ statusCode: 404, statusMessage: "Page introuvable" });
    }
    useSeoMeta({
      title: `Conditions G\xE9n\xE9rales de Vente | ${((_b = content.value) == null ? void 0 : _b.seoSiteName) || "Angel Dreamer"}`,
      robots: "index, follow"
    });
...
//# sourceMappingURL=cgv-Bv3YfF7e.mjs.map
