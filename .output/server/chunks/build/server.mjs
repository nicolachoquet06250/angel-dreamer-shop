import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, hasInjectionContext, inject, ref, Suspense, Fragment, isRef, computed, toValue, onServerPrefetch, reactive, useSSRContext, createApp, shallowReactive, withAsyncContext, onErrorCaptured, unref, createVNode, resolveDynamicComponent, effectScope, nextTick, toRef, defineAsyncComponent, mergeProps, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { T as parseURL, N as encodePath, U as decodePath, e as createError$1, q as getRequestURL, V as hasProtocol, W as isScriptProtocol, R as joinURL, X as withQuery, Y as sanitizeStatusCode, Z as getContext, $ as $fetch, _ as hash, a0 as executeAsync, a1 as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_slug_-lr0GBJAQ.mjs')
  },
  {
    name: "produits-slug",
    path: "/produits/:slug()",
    component: () => import('./_slug_-BOyR0Rhq.mjs')
  },
  {
    name: "univers-id",
    path: "/univers/:id()",
    component: () => import('./_id_-CSv8O2fN.mjs'),
    children: [
      {
        name: "univers-id-category",
        path: ":category()",
        component: () => import('./_category_-CR1QaNUK.mjs')
      }
    ]
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-CRC7E_fA.mjs'),
    children: [
      {
        name: "admin-tab",
        path: ":tab()",
        component: () => import('./_tab_-BqKKetxt.mjs')
      },
      {
        name: "admin-path",
        path: ":path(.*)*",
        component: () => import('./_...path_-DpcIMe3t.mjs')
      }
    ]
  },
  {
    name: "cgu",
    path: "/cgu",
    component: () => import('./cgu-C9G_khMI.mjs')
  },
  {
    name: "cgv",
    path: "/cgv",
    component: () => import('./cgv-Bv3YfF7e.mjs')
  },
  {
    name: "changer-mot-de-passe",
    path: "/changer-mot-de-passe",
    component: () => import('./changer-mot-de-passe-DxwDj1E8.mjs')
  },
  {
    name: "commande",
    path: "/commande",
    component: () => import('./commande-BbtEHgY0.mjs')
  },
  {
    name: "compte",
    path: "/compte",
    component: () => import('./compte-CApwluQG.mjs')
  },
  {
    name: "connexion",
    path: "/connexion",
    component: () => import('./connexion-DTTM3UOH.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-lPNpCqQt.mjs')
  },
  {
    name: "inscription",
    path: "/inscription",
    component: () => import('./inscription-C8zEjAdZ.mjs')
  },
  {
    name: "mot-de-passe-oublie",
    path: "/mot-de-passe-oublie",
    component: () => import('./mot-de-passe-oublie-B5wVU_CF.mjs')
  },
  {
    name: "panier",
    path: "/panier",
    component: () => import('./panier-Dv87H6f8.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DFs7m_Ng.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BozipGah.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C3Zht_1G.mjs'));
...
export { __nuxt_component_7 as _, useRouter as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, useRoute as f, useFetch as g, createError as h, defaultSiteContent as i, useRequestURL as j, useSeoMeta as k, navigateTo as n, resolveRouteObject as r, useHead as u };
