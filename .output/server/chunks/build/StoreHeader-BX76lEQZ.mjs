...
import { computed, defineComponent, ref, withAsyncContext, unref, withCtx, createTextVNode, toDisplayString, createVNode, toRef, isRef, useSSRContext } from 'vue';
import { ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from 'vue/server-renderer';
import { g as useFetch, b as useNuxtApp } from './server.mjs';
...
function useState(...args) {
  ...
  if (init) {
    (_b = (_a = nuxtApp._state)[key]) != null ? _b : _a[key] = { _default: init };
  }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    announcement: {},
    paymentLabel: { default: "Paiement s\xE9curis\xE9" },
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="${ssrRenderClass(unref(styles).announcement)}">${ssrInterpolate(__props.announcement || "\u{1F1EB}\u{1F1F7} Imprim\xE9 en France \xB7 Livraison d\xE8s 3,90 \u20AC")}<span>${ssrInterpolate(__props.paymentLabel)}</span></div><header class="${ssrRenderClass(unref(styles).header)}"><button class="${ssrRenderClass(unref(styles).menuButton)}" aria-label="Menu">\u2630</button>`);
      ...
      if (["admin", "demo"].includes(((_b = (_a = unref(session)) == null ? void 0 : _a.user) == null ? void 0 : _b.role) || "")) {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: ((_c = unref(session)) == null ? void 0 : _c.user) ? "/compte" : "/connexion",
        "aria-label": ((_d = unref(session)) == null ? void 0 : _d.user) ? "Mon compte" : "Se connecter"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`\u2659 `);
      ...
      if (((_f = (_e = unref(session)) == null ? void 0 : _e.user) == null ? void 0 : _f.role) !== "demo") {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/panier",
...
export { __nuxt_component_0 as _, useState as a, styles as s, useShopCart as u };
//# sourceMappingURL=StoreHeader-BX76lEQZ.mjs.map
