...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const canNext = computed(() => {
      var _a;
      return overflow.value && index.value < (((_a = track2.value) == null ? void 0 : _a.children.length) || 0) - 1;
    });
    const compact2 = computed(() => props.label.includes("onglets"));
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: _ctx.$style.root
      }, _attrs))}><button type="button" class="${ssrRenderClass([_ctx.$style.arrow, _ctx.$style.previous])}"${ssrRenderAttr("aria-label", `Faire d\xE9filer ${__props.label} vers la gauche`)} style="${ssrRenderStyle(unref(canPrev) ? null : { display: "none" })}">&lt; </button><div class="${ssrRenderClass([_ctx.$style.track, unref(compact2) && _ctx.$style.compact, __props.trackClass])}"${ssrRenderAttr("role", __props.role || (unref(compact2) ? "tablist" : void 0))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div><button type="button" class="${ssrRenderClass([_ctx.$style.arrow, _ctx.$style.next])}"${ssrRenderAttr("aria-label", `Faire d\xE9filer ${__props.label} vers la droite`)} style="${ssrRenderStyle(unref(canNext) ? null : { display: "none" })}">&gt; </button></div>`);
    };
  }
});
...
export { __nuxt_component_1 as _, engagementStyles as e };
//# sourceMappingURL=engagement-icons.module-BtNn5Pri.mjs.map
