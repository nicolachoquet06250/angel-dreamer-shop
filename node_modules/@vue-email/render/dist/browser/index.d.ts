...
declare const cleanup$1_cleanup: typeof cleanup;
declare namespace cleanup$1 {
  export { cleanup$1_cleanup as cleanup };
}

export { type ExtractComponentProps, type Options, type VNode, cleanup$1 as cleanup, plainTextSelectors, render };
